...
| Metric | Value |
|--------|-------|
| Recording sessions | **47** (43 train, 4 unseen) |
| Devices | iPhone 7 Plus (23), SM-G955U (12), SM-G970U1 (12) |
| Labelled window CSVs | **779** |
| Training windows | 713 |
| Unseen test windows | 66 (4 Jul 1 sessions) |
| Overall test accuracy | **75.8 %** (Viterbi per session) |
...
*Figure 6 — Confusion matrix on unseen test windows (Viterbi per session, 75.8 % overall accuracy).*
